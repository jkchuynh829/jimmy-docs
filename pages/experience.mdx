...
At Tell.ie, a site builder platform tailored for creators and artists, I played a significant role in developing key
features that promote creator content and drive their revenue. My primary contributions include the Designer and Token
Gating functionalities. The Designer serves as the main tool for building pages on Tell.ie, offering users the ability
to create intricate layouts through a user-friendly drag-and-drop interface. Token Gating enables users to require web3
asset ownership for granting access to their content, enhancing the platform's security and exclusivity.
...
At MedCircle, a subscription-based video service dedicated to providing content from highly-regarded mental health
professionals, I was responsible developing the video platform, internal CMS system, and subscription service. My
contributions streamlined payment processing and enhanced the overall user experience, while the CMS system facilitated
seamless content management for the MedCircle team.
...
-   Stripe integration for streamlined payment processing and plan management
